...
분류: **조사**. SSOT가 아니다. 여기 있는 값을 근거로 코드를 바꾸지 않는다.
확정된 것은 `docs/ref/`로 승격돼 있다.
...
| `vision-imitation.md` | 모방학습 — 접근법 3안 · LeRobot/ACT/Diffusion · 손목 뎁스카메라 · 사다리 5칸 · 함정 | 범위·안전은 D45 와 `ref/contract/LAYOUT-METRICS-CONTRACT.md` §모방학습·§카메라 로 승격. 카메라 기종·Min-Z 는 D61 로 `ref/arch/DEPTH-CAM.md` 승격. 나머지 미승격. **`Vision/` 착수 시 정본 입구** |
