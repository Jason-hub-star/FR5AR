...
> **`API-CONTRACT.md` 에서 이관** (2026-08-05 · 무게 초과선). 유니티 실측 기록이라
> 이 문서 맨 위의 출처 배너가 그대로 걸린다 — **웹 기준으로 오인하지 않는다.**
> 브리지 계약 본문은 [`../contract/API-CONTRACT.md`](../contract/API-CONTRACT.md).
...
숫자의 원본 대조는 이 문서 위쪽 절들이다 (2026-07-30).
