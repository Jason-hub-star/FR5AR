...
**배치 편집기가 섰다** — 빈 방/프리셋에서 짓고, 끌고 돌리고 크기까지 고치고, 되돌리고,
새로고침해도 남는다. **저장의 천장은 브라우저 한 대**다 — 팀 공유는 이관 H (D46).
...
`BUILD-VITE.md` §이관 순서가 정본이다. **A~D·G 완료.**
남은 것 — ①**저장을 팀 공유로**(이관 H · D46) ②L2 AR 검증 → L3 비교
