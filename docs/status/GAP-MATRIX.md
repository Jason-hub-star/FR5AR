...
| 문서 무게 경고 — INDEX 52행(45) · PROJECT-STATUS · DECISION-LOG · 07-31 evidence 12건(8) | 진입 비용 | OPEN | 전부 soft 경고(게이트는 통과). **옮기는 것은 사람이 확인하고 한다**(D18). evidence 눈금은 총량이 아니라 **날짜 폴더 하나당** 이다 (D37) |
